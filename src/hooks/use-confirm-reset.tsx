 ...
 export const useConfirmReset = (
    ...
    // )
        ...
        <ResponsiveModal open={ promise !== null } onOpenChange={handleCancel}>
            {/* Red bar at the top */}
            <div className="absolute top-0 left-0 w-full h-2 bg-green-500 z-10 rounded-t-lg" />
            ...
            <div className="bg-gray-100 px-4 py-4 flex flex-col lg:flex-row gap-2 lg:justify-end rounded-b-md">
                ...
                <Button variant="destructive" onClick={handleConfirm} className="flex-1 bg-green-500">Confirm</Button>
            </div>
        </ResponsiveModal>
  );
